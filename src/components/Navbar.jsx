    ...
    <nav className="sticky top-0 z-50 bg-gray-950/80 backdrop-blur-md border-b border-gray-800">
      <div className="max-w-7xl mx-auto px-4 py-4 flex items-center justify-between">
        ...
        <div className="hidden md:flex items-center gap-8">
          <Link to="/#features" className="text-gray-300 hover:text-indigo-400 transition-smooth">Features</Link>
          <Link to="/#pricing" className="text-gray-300 hover:text-indigo-400 transition-smooth">Pricing</Link>
          <Link to="/blog" className="text-gray-300 hover:text-indigo-400 transition-smooth">Blog</Link>
          <Link to="/contact" className="text-gray-300 hover:text-indigo-400 transition-smooth">Contact</Link>
        </div>
            ...
            <div className="relative">
              ...
              {openUserMenu && (
                <div className="absolute right-0 mt-2 w-44 bg-gray-900 border border-gray-800 rounded-lg shadow-xl">
                  <Link to="/dashboard" className="block px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white">
                    Dashboard
                  </Link>
                  <Link to="/settings" className="block px-4 py-2 text-gray-300 hover:bg-gray-800 hover:text-white">
                    Settings
                  </Link>
                  <button
                    onClick={logout}
      ...
      {isOpen && (
        <div className="md:hidden bg-gray-950 border-t border-gray-800">
          <div className="flex flex-col px-4 py-4 gap-4">
            <Link to="/#features" className="text-gray-300 hover:text-indigo-400">Features</Link>
            <Link to="/#pricing" className="text-gray-300 hover:text-indigo-400">Pricing</Link>
            <Link to="/blog" className="text-gray-300 hover:text-indigo-400">Blog</Link>
            ...
            {isLoggedIn ? (
              <>
                ...
                <Link to="/settings" className="text-gray-300 hover:text-indigo-400">Settings</Link>
                <button
                  onClick={logout}
